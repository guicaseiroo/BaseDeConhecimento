...
_RAW_TO_EMAIL_MAPPING = {
    raw: email for email, raw in _EMAIL_TO_RAW_MAPPING.items()
}
...
class _Validator(Generic[T]):
    ...
    def _process_description_content_type(self, value: str) -> str:
        ...
        if (
            ...
            or content_type not in value.lower()
        ):
            raise self._invalid_metadata(
        ...
        if (
            ...
            and variant not in markdown_variants
        ):
            raise self._invalid_metadata(
...
class Metadata:
    ...
    *validate* parameter)"""
    ...
    description: _Validator[
        str | None
    ] = _Validator()  # TODO 2.1: can be in body
