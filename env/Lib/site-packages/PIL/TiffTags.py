...
class TagInfo(_TagInfo):
    ...
    def __new__(
        cls, value=None, name='unknown', type=None, length=None, enum=None
    ):
...
def lookup(tag, group=None):
    ...
    if group is not None:
        info = (
            TAGS_V2_GROUPS[group].get(tag) if group in TAGS_V2_GROUPS else None
        )
    else:
...
TAGS_V2_GROUPS = {
    ...
    # InteroperabilityIFD
    40965: {
        1: ('InteropIndex', ASCII, 1),
        2: ('InteropVersion', UNDEFINED, 1),
    },
}
