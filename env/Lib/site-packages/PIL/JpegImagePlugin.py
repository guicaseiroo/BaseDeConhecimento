...
def _getmp(self):
    ...
    try:
        ...
        for entrynum in range(0, quant):
            ...
            mpentryattr = {
                'DependentParentImageFlag': bool(
                    mpentry['Attribute'] & (1 << 31)
                ),
                'DependentChildImageFlag': bool(
                    mpentry['Attribute'] & (1 << 30)
                ),
                'RepresentativeImageFlag': bool(
                    mpentry['Attribute'] & (1 << 29)
                ),
...
def _save(im: Image.Image, fp: IO[bytes], filename: str | bytes) -> None:
    ...
    progressive = info.get('progressive', False) or info.get(
        'progression', False
    )
...
Image.register_extensions(
    JpegImageFile.format, ['.jfif', '.jpe', '.jpg', '.jpeg']
)
