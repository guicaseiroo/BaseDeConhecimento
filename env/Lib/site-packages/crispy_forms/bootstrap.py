    ...
    **kwargs : dict, optional
    ...
    def render(
        ...
        **kwargs,
        ...
        extra_context = (
            extra_context.copy() if extra_context is not None else {}
        )
...
class FormActions(LayoutObject):
    ...
    **kwargs : dict, optional
    ...
    def __init__(
        self, *fields, css_id=None, css_class=None, template=None, **kwargs
    ):
...
class StrictButton(TemplateNameMixin):
    ...
    **kwargs : dict, optional
    ...
    def __init__(
        self, content, css_id=None, css_class=None, template=None, **kwargs
    ):
    ...
    **kwargs : dict, optional
    ...
    def __contains__(self, field_name):
        ...
        return field_name in (
            pointer.name for pointer in self.get_field_names()
        )
...
class TabHolder(ContainerHolder):
    ...
    **kwargs : dict, optional
    ...
    def render(self, form, context, template_pack=TEMPLATE_PACK, **kwargs):
        ...
        links = SafeString(
            ''.join(tab.render_link(template_pack) for tab in self.fields)
        )
