...
class TestAdminPanelWidget(StaticLiveServerTestCase):
    ...
    def _go_to_demo_application_in_admin(self):
        self.selenium.get(
            '{}{}'.format(
                ...
                '/admin/demo_application/examplemodel/add/',
            )
        )
    ...
    def _focus_cursor_in_editor(self):
        self.frame = self.selenium.find_element(
    ...
    def _go_to_upload_tab(self):
        self.selenium.find_element(
            By.CSS_SELECTOR, "a[title='Upload']"
        ).click()
        sleep(1)
    ...
    def _upload_image(self):
        ...
        self.selenium.find_element(
            By.CLASS_NAME, 'cke_dialog_ui_fileButton'
        ).click()
        sleep(2)
    ...
    def _assert_image_uploaded(self):
        ...
        expected_thumbnail_path = os.path.join(
            upload_directory, 'close_thumb.png'
        )
...
class TestAdminPanelWidgetForDummyImageBackend(TestAdminPanelWidget):
    def _assert_image_uploaded(self):
        ...
        self.assertTrue(
            os.path.isfile(expected_image_path), expected_image_path
        )
        self.assertFalse(
