...
from .utils import (get_absolute_media_path, get_media_url,
                    remove_upload_directory, sha1)
...
class PillowTestCase(TestCase):
    ...
    def test_upload_file_disabled(self):
        ...
        with open(filepath, 'rb') as fp:
            response = self.client.post(
                reverse('ckeditor_upload'), {'upload': fp}
            )
        self.assertEqual(200, response.status_code)
    ...
    def test_upload_png(self):
        ...
        self.assertEqual(744, os.path.getsize(thumb))
